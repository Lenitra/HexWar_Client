...
public class TB1_Ui_Char_Panel : MonoBehaviour {
	...
	void Start () {
		...
		actions = character.GetComponent<TB1_Actions> ();
 


		CreateActionButton("Idle");
        CreateActionButton("OpenDoor");
        CreateActionButton("Destroy1");
		CreateActionButton("Destroy2");
	...
	public void OpenPublisherPage() {
		Application.OpenURL ("https://www.assetstore.unity3d.com/#!/content/112349");
	}
